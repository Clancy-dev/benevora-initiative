...
import { ArrowLeft, Link as LinkIcon, Activity, Calendar } from 'lucide-react';

export default async function FacebookDetailPage({
  params,
}: {
      ...
      <div className="w-full space-y-8 mx-auto lg:mx-0">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              View and manage Facebook page configuration
            </p>
          </div>
        </div>
        ...
        <Card className="shadow-sm border border-border/60 w-full">
          <CardHeader>
            ...
            <CardDescription>
              Detailed overview of this Facebook integration
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex gap-3 pt-4 border-t">
              <Link
                href={`/dashboard/social-media/facebook/edit?id=${link.id}`}
                className="flex-1"
              >
