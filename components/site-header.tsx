...
const pageTitles: Record<string, string> = {
  ...
  "/dashboard/social-media": "Social Media Intergration",
  "/dashboard/social-media/whatsapp": "Whatsapp Intergration",
  "/dashboard/social-media/whatsapp/trash": "Trash for Whatsapp Intergration"
}
